...
!(function (t, e) {
    ...
    var rt = {
        ...
        wt = function (t, e) {
            var n = $t[xt(t)];
            return (
                n == jt || (n != Bt && ("function" == typeof e ? v(e) : !!e))
            );
        },
            ...
            if ((n = l ? d : a ? d[s] || H(s, {}) : (d[s] || {}).prototype))
                for (i in e) {
                    if (
                        ...
                        !Tt(l ? i : s + (a ? "." : "#") + i, t.forced) &&
                            void 0 !== r)
                    ) {
                        if (typeof u == typeof r) continue;
                        Dt(u, r);
                    }
                    (t.sham || (r && r.sham)) && N(u, "sham", !0),
                        ut(n, i, u, t);
                }
        },
        It =
        ...
        Pt = function (t) {
            return (
                Mt[t] || (Mt[t] = (It && Rt[t]) || (It ? Rt : q)("Symbol." + t))
            );
        },
        Nt =
            Object.keys ||
        ...
        Xt =
            ...
            v(function () {
                ...
                return (
                    ...
                    7 != Zt({}, t)[n] ||
                        "abcdefghijklmnopqrst" != Nt(Zt({}, e)).join("")
                );
            })
                ? function (t, e) {
                      for (
    ...
    It ||
        (ut(
            (Re = function () {
                ...
                return (
                    g && Je && Qe(Ie, e, { configurable: !0, set: n }), Ze(e, t)
                );
            }).prototype,
            "toString",
            function () {
                ...
                (g &&
                    ...
                    Rn !== Object.prototype &&
                        ...
                        (Bn(s) !== Rn &&
                            (In
                                ? In(s, Rn)
                                : "function" != typeof s[Pn] && N(s, Pn, Nn)),
                        Ce(s, h, !0))),
                "values" == r &&
                    d &&
                    "values" !== d.name &&
    ...
    var ii = b.f,
        ri = function (t) {
            return function (e) {
                for (
                    var n, i = D(e), r = Nt(i), u = r.length, o = 0, s = [];
                    u > o;

                )
                    (n = r[o++]),
                        (g && !ii.call(i, n)) || s.push(t ? [n, i[n]] : i[n]);
                return s;
            };
        },
                    ...
                    function (t, r) {
                        ...
                        for (var p = 0, d = 0, v = []; d < s.length; ) {
                            ...
                            if (
                                null === y ||
                                (g = _i(
                                    pt(h.lastIndex + (Ii ? 0 : d)),
                                    s.length
                                )) === p
                            )
                                d = ji(s, d, a);
                            else {
                                if ((v.push(s.slice(p, d)), v.length === f))
                                    return v;
                                for (var E = 1; E <= y.length - 1; E++)
                                    if ((v.push(y[E]), v.length === f))
                                        return v;
                                d = p = g;
                            }
                        }
                ...
                r(t, [
                    {
                        ...
                        value: function (t) {
                            ...
                            i && r
                                ? (e.topOffset &&
                                      o.push(this.getExtra("top", e.topOffset)),
                                  o.push(n),
                                  e.bottomOffset &&
                                      o.push(
                                          this.getExtra(
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (this.blockHeight =
                                this.itemHeight * pe.BLOCK_ROWS),
                                (this.clusterRows =
                                    pe.BLOCK_ROWS * pe.CLUSTER_BLOCKS),
                                (this.clusterHeight =
                                    this.blockHeight * pe.CLUSTER_BLOCKS);
                        },
                    },
                    {
                        key: "getNum",
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            var n = Math.max(
                                    (this.clusterRows - pe.BLOCK_ROWS) * e,
                                    0
                                ),
        ...
        return [
            ...
            function (t, r) {
                ...
                for (var h = []; ; ) {
                    ...
                    if ((h.push(f), !a)) break;
                    "" === String(f[0]) &&
                        (o.lastIndex = ji(s, pt(o.lastIndex), c));
                }
                ...
                r(i, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                (this.$drop = t(
                                    '<div class="ms-drop '.concat(
                                        this.options.position,
                                        '" />'
                                    )
                                )),
                                (this.$close =
                                    this.$choice.find(".icon-close")),
                                ...
                                (this.selectAllName =
                                    'data-name="selectAll'.concat(i, '"')),
                                (this.selectGroupName =
                                    'data-name="selectGroup'.concat(i, '"')),
                                (this.selectItemName =
                                    'data-name="selectItem'.concat(i, '"')),
                        ...
                        value: function () {
                            ...
                            if (this.options.data) {
                                if (Array.isArray(this.options.data))
                                    this.data = this.options.data.map(function (
                                        t
                                    ) {
                        ...
                        value: function (t) {
                            ...
                            (this.allSelected =
                                this.data.filter(function (t) {
                                    return (
                                        t.selected && !t.disabled && t.visible
                                    );
                                }).length ===
                                this.data.filter(function (t) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            if (
                                ((this.filterText = ""),
                                !this.options.filter &&
                                    this.options.filterByDataLength)
                            ) {
                                var t = 0,
                                    e = !0,
                                    n = !1,
                                ...
                                this.options.filter =
                                    t > this.options.filterByDataLength;
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                var r = function () {
                                    (t.updateDataStart =
                                        t.virtualScroll.dataStart + n),
                                        (t.updateDataEnd =
                                            t.virtualScroll.dataEnd + n),
                                        t.updateDataStart < 0 &&
                                            (t.updateDataStart = 0),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this;
                            (this.$searchInput =
                                this.$drop.find(".ms-search input")),
                                ...
                                (this.$noResults =
                                    this.$drop.find(".ms-no-results"));
                            var n = function (n) {
                                n.preventDefault(),
                                    t(n.target).hasClass("icon-close") ||
                                        e[
                                            e.options.isOpen ? "close" : "open"
                                        ]();
                            };
                            this.$label &&
                                this.$label.length &&
                                ...
                                this.$selectAll
                                    ...
                                    .on("click", function (n) {
                                        e._checkAll(
                                            t(n.currentTarget).prop("checked")
                                        );
                                    }),
                                this.$selectGroups
                                    .off("click")
                    ...
                    },
                    {
                        ...
                        value: function () {
                            for (
                                var t = this.updateDataStart;
                                t < this.updateDataEnd;
                                t++
                            ) {
