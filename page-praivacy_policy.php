...
<main>
    <div class="main_inner">
        ...
        <div class="text">
            ...
            <p>
                本プライバシーポリシーは、徳島こども食堂ナビ（以下「本サイト」といいます。）
                の各種サービス（本サイトによる情報提供、お問い合わせ等）において、本サイトを利用する方々の個人情報およびそれに準ずる情報を取り扱う際に、本サイトが遵守する方針を示したものです。
            </p>
        </div>
        <div class="text">
            <h3 class="text_title">第１章・基本方針</h3>
            <p>
        ...
        <div class="text">
            <h3 class="text_title">第２章・収取する情報の範囲</h3>
            <p>
        ...
        <div class="text">
            <h3 class="text_title">損害等の責任について</h3>
            <p>
        ...
        <div class="text">
            ...
            <p>
                本サイトで掲載している画像の著作権や肖像権等は、各権利所有者に帰属します。万が一問題がある場合は、お問い合わせよりご連絡いただけますよう宜しくお願い致します。
            </p>
        </div>
        <div class="text">
            <h3 class="text_title">無断転載</h3>
            <p>
